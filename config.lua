...
Config.Strings = {
	ExitVehicle = "Baje del vehículo para repostar",
	EToRefuel = "Presione ~g~E ~w~ para respostar el vehículo",
	JerryCanEmpty = "El bidón está vacío",
	FullTank = "Depósito lleno",
	PurchaseJerryCan = "Presione ~g~E ~w~ para comprar un bidon de combustible ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presione ~g~E ~w~ para detener el repostaje",
	CancelFuelingJerryCan = "Presione ~g~E ~w~ para detener el repostaje",
	NotEnoughCash = "No tiene suficiente efectivo",
	RefillJerryCan = "Presione ~g~E ~w~ para rellenar el bidón de combustible ",
	NotEnoughCashJerryCan = "No tiene suficiente efectivo para rellenar el bidón",
	JerryCanFull = "Bidón lleno",
	TotalCost = "Coste",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presione ~g~E ~w~ para usaur un bidón"
